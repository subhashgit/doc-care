...
<form class="needs-validation" action="includes/staff-add.inc.php" enctype="multipart/form-data" method="post" novalidate  autocomplete="off">
      ...
      <div class="row mb-3">
                      <label for="certificate" class="col-md-4 col-lg-3 col-form-label"> Certificate(optional)</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                     ...
                     <button class="btn btn-lg btn-primary btn-block mb-5  mt-5" type="submit" name='add-staff'>Save</button>
        </form>
