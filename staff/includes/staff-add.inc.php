...
if (isset($_POST['add-staff'])) {
    ...
    if (empty($full_name) || empty($number) ) {
        ...
        $sql = "INSERT INTO staff  (parent, staff_name, staff_number, staff_profile,  staff_document, staff_gender, staff_bio, role, created_at)
        VALUES ('$id', '$full_name', '$number','$FileNameNew',   '$certifyNameNew' , '$gender', '$bio', '$role', '$created_at')";
